...
- State what's wrong and why it matters for _this_ codebase specifically (not generic advice) — e.g. "this bypasses `DatabaseService`, so it won't participate in the Tier 1/2/3 loading contract" is useful; "consider using a service layer" is not.
