...
export class BalanceComponent {
  static get allAssets(): Asset[] {
    return AppStateService.instance.allAssets;
  }
  static set allAssets(v: Asset[]) {
    AppStateService.instance.allAssets = v;
  }
  static get allShares(): Share[] {
    return AppStateService.instance.allShares;
  }
  static set allShares(v: Share[]) {
    AppStateService.instance.allShares = v;
  }
  static get allInvestments(): Investment[] {
    return AppStateService.instance.allInvestments;
  }
  static set allInvestments(v: Investment[]) {
    AppStateService.instance.allInvestments = v;
  }

  static get liabilities(): Liability[] {
    return AppStateService.instance.liabilities;
  }
  static set liabilities(v: Liability[]) {
    AppStateService.instance.liabilities = v;
  }
