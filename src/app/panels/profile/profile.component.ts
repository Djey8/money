...
setTimeout(() =>
  import('../info/info-smile/info-smile.component').then(
...
setTimeout(() =>
  import('../policy/policy.component').then((m) => (PolicyComponent = m.PolicyComponent)),
);
let InstructionsComponent: any;
setTimeout(() =>
  import('../instructions/instructions.component').then(
...
export class ProfileComponent implements OnInit {
  ...
  constructor(
    ...
    ProfileComponent.username =
      this.localStorage.getData('username') == ''
        ? 'Username'
        : this.localStorage.getData('username');
    ProfileComponent.mail =
      this.localStorage.getData('email') == ''
        ? 'example@traiber.com'
        : this.localStorage.getData('email');
