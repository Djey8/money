...
setTimeout(() =>
  import('../../../main/subscription/subscription.component').then(
...
export class InfoSubscriptionComponent extends BaseInfoComponent implements OnInit {
   ...
   */
  static setInfoSubscriptionComponent(
    id: number,
    title: string,
    account: string,
    amount: number,
  ...
  copySubscription() {
    ...
    AppComponent.copySubcription(
      InfoSubscriptionComponent.title,
      InfoSubscriptionComponent.account,
      InfoSubscriptionComponent.amount,
      `${InfoSubscriptionComponent.category}`,
  ...
  updateSubscription() {
    ...
    if (
      ...
      AppStateService.instance.allSubscriptions[InfoSubscriptionComponent.index].title =
        this.titleTextField;
      AppStateService.instance.allSubscriptions[InfoSubscriptionComponent.index].account =
        this.selectedOption;
      AppStateService.instance.allSubscriptions[InfoSubscriptionComponent.index].amount =
        this.amountTextField;
      AppStateService.instance.allSubscriptions[InfoSubscriptionComponent.index].startDate =
        this.startDateTextField;
      AppStateService.instance.allSubscriptions[InfoSubscriptionComponent.index].endDate =
        this.endDateTextField;
      AppStateService.instance.allSubscriptions[InfoSubscriptionComponent.index].category =
        this.categoryTextField;
      AppStateService.instance.allSubscriptions[InfoSubscriptionComponent.index].comment =
        this.commentTextField;
      AppStateService.instance.allSubscriptions[InfoSubscriptionComponent.index].frequency = this
        .frequencyField as any;
    ...
    for (let i = 0; i < AppStateService.instance.liabilities.length; i++) {
      if (
        ...
        AppStateService.instance.liabilities[i].amount +=
          this.amountTextField -
          SubscriptionComponent.allSubscriptions[InfoSubscriptionComponent.index].amount;
      }
    }
  }
  ...
  updateStorage() {
    try {
      ...
      // Fire
      //update database
      const write10 = this.database.writeObject(
        'fire',
      ...
      // Transaction
      //update database
      const write12 = this.database.writeObject(
        'transactions',
      ...
      // Subscriptions
      // update subcritpions
      const write13 = this.database.writeObject(
        'subscriptions',
        AppStateService.instance.allSubscriptions,
      );

      //Liabilities
      const write14 = this.database.writeObject(
        'balance/liabilities',
        ...
        if (observables.length > 0) {
          ...
          const handleComplete = () => {
            ...
            if (completed === observables.length) {
              ...
              this.localStorage.saveData(
                'revenues',
                JSON.stringify(AppStateService.instance.allRevenues),
              );
              this.localStorage.saveData(
                'splurgeEx',
              ...
              this.localStorage.saveData(
                'dailyEx',
                JSON.stringify(AppStateService.instance.dailyExpenses),
              );
              this.localStorage.saveData(
                'smileEx',
                JSON.stringify(AppStateService.instance.smileExpenses),
              );
              this.localStorage.saveData(
                'fireEx',
                JSON.stringify(AppStateService.instance.fireExpenses),
              );
              this.localStorage.saveData(
                'mojoEx',
                JSON.stringify(AppStateService.instance.mojoExpenses),
              );
