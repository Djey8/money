...
export class InfoLiabilitieComponent extends BaseInfoComponent {
  ...
  static setInfoLiabilitieComponent(
    id: number,
    title: string,
    amount: number,
    credit: number,
  ...
  payback() {
    ...
    AddComponent.commentTextField =
      'Payback Liabilitie ' +
      InfoLiabilitieComponent.amount +
      ' ' +
      InfoLiabilitieComponent.credit +
      ';';
  ...
  updateLiabilitie() {
    ...
    if (this.titleTextField == '') {
      ...
      if (
        AppStateService.instance.liabilities[InfoLiabilitieComponent.index].tag !=
        this.titleTextField
      ) {
      ...
      if (!InfoLiabilitieComponent.isError) {
        ...
        AppStateService.instance.liabilities[InfoLiabilitieComponent.index].tag =
          this.titleTextField;
        AppStateService.instance.liabilities[InfoLiabilitieComponent.index].amount =
          this.amountTextField;
        AppStateService.instance.liabilities[InfoLiabilitieComponent.index].credit =
          this.creditTextField;
        AppStateService.instance.liabilities[InfoLiabilitieComponent.index].investment =
          this.isInvestment;
