...
setTimeout(() =>
  import('src/app/main/daily/daily.component').then((m) => (DailyComponent = m.DailyComponent)),
);
...
export class AddComponent extends BaseAddComponent implements OnInit, AfterViewInit {
  ...
  dateTextField =
    this.d.getFullYear() +
    '-' +
    this.zeroPadded(this.d.getMonth() + 1) +
    '-' +
    this.zeroPadded(this.d.getDate());
  ...
  addTransaction() {
    ...
    if (
      !this.validateRequired([
        ...
        {
          name: 'category',
          value: AddComponent.categoryTextField === '@' ? '' : AddComponent.categoryTextField,
          label: 'Category',
        },
      ])
    ) {
    ...
    setTimeout(() => {
      try {
        ...
        if (
          ...
          AppStateService.instance.allRevenues.length === 0
        ) {
          AppStateService.instance.allRevenues =
        ...
        if (
          ...
          AppStateService.instance.allIntrests.length === 0
        ) {
          AppStateService.instance.allIntrests =
        ...
        if (
          ...
          AppStateService.instance.allProperties.length === 0
        ) {
          AppStateService.instance.allProperties =
        ...
        if (
          ...
          AppStateService.instance.dailyExpenses.length === 0
        ) {
          AppStateService.instance.dailyExpenses =
        ...
        if (
          ...
          AppStateService.instance.splurgeExpenses.length === 0
        ) {
          AppStateService.instance.splurgeExpenses =
        ...
        if (
          ...
          AppStateService.instance.smileExpenses.length === 0
        ) {
          AppStateService.instance.smileExpenses =
        ...
        if (
          ...
          AppStateService.instance.fireExpenses.length === 0
        ) {
          AppStateService.instance.fireExpenses =
        ...
        if (
          ...
          AppStateService.instance.mojoExpenses.length === 0
        ) {
          AppStateService.instance.mojoExpenses =
        ...
        if (
          ...
          AppStateService.instance.allAssets.length === 0
        ) {
          AppStateService.instance.allAssets =
        ...
        if (
          ...
          AppStateService.instance.allShares.length === 0
        ) {
          AppStateService.instance.allShares =
        ...
        if (
          ...
          AppStateService.instance.allInvestments.length === 0
        ) {
          AppStateService.instance.allInvestments =
        ...
        if (
          ...
          AppStateService.instance.liabilities.length === 0
        ) {
          AppStateService.instance.liabilities =
        ...
        if (
          ...
          AppStateService.instance.allSmileProjects =
            this.localStorage.getData('smile') == ''
              ? []
              : migrateSmileArray(JSON.parse(this.localStorage.getData('smile')));
        }
        if (
          !AppStateService.instance.allFireEmergencies ||
          AppStateService.instance.allFireEmergencies.length === 0
        ) {
          AppStateService.instance.allFireEmergencies =
            this.localStorage.getData('fire') == ''
              ? []
              : migrateFireArray(JSON.parse(this.localStorage.getData('fire')));
        }
        ...
        if (AddComponent.isShare) {
          if (AddComponent.shareTextField !== '') {
            if (this.showShareOptions) {
              AddComponent.shareTextField = String(
                Math.round(
                  parseFloat(AddComponent.amountTextField) *
                    (parseFloat(AddComponent.shareTextField) / 100) *
                    100,
                ) / 100,
              );
            }
            ...
            AddComponent.commentTextField +=
              'shared ' + AddComponent.amountTextField + ' ' + AppStateService.instance.currency;
          ...
          for (let i = 0; i < AppStateService.instance.allShares.length; i++) {
            if (AppStateService.instance.allShares[i].tag === title) {
              AppStateService.instance.allShares[i].quantity =
                Number(AppStateService.instance.allShares[i].quantity) + parseFloat(quantity);
            ...
            if (AppStateService.instance.allGrowProjects[i].title === title) {
              ...
              if (found) {
                ...
                AppStateService.instance.allGrowProjects[i].share.quantity =
                  Number(AppStateService.instance.allGrowProjects[i].share.quantity) +
                  parseFloat(quantity);
              } else {
          ...
          for (let i = 0; i < AppStateService.instance.allInvestments.length; i++) {
            if (AppStateService.instance.allInvestments[i].tag === title) {
              AppStateService.instance.allInvestments[i].deposit =
                Number(AppStateService.instance.allInvestments[i].deposit) + parseFloat(deposit);
              AppStateService.instance.allInvestments[i].amount =
                Number(AppStateService.instance.allInvestments[i].amount) + parseFloat(mortage);
              found = true;
            }
          }
          if (!found) {
          ...
          for (let i = 0; i < AppStateService.instance.liabilities.length; i++) {
            if (AppStateService.instance.liabilities[i].tag === 'M-' + title) {
              AppStateService.instance.liabilities[i].amount =
                Number(AppStateService.instance.liabilities[i].amount) + parseFloat(mortage);
              foundM = true;
            }
          }
          if (!foundM) {
            ...
            if (AppStateService.instance.allGrowProjects[i].title === title) {
              ...
              if (found) {
                ...
                AppStateService.instance.allGrowProjects[i].investment.deposit =
                  Number(AppStateService.instance.allGrowProjects[i].investment.deposit) +
                  parseFloat(deposit);
                AppStateService.instance.allGrowProjects[i].investment.amount =
                  Number(AppStateService.instance.allGrowProjects[i].investment.amount) +
                  parseFloat(mortage);
              } else {
                AppStateService.instance.allGrowProjects[i].amount = amount;
                AppStateService.instance.allGrowProjects[i].investment.deposit =
        ...
        if (AddComponent.isLiabilitie) {
          if (this.showLoanOptions) {
            ...
            AddComponent.loanTextField = String(
              Math.round(
                parseFloat(AddComponent.amountTextField) *
                  -1 *
                  (parseFloat(AddComponent.loanTextField) / 100) *
                  100,
              ) / 100,
            );
            AddComponent.amountTextField = String(
              parseFloat(AddComponent.amountTextField) + parseFloat(AddComponent.loanTextField),
            );
          }
          ...
          if (this.showCreditOptions) {
            ...
            AddComponent.creditTextField = String(
              Math.round(
                parseFloat(AddComponent.loanTextField) *
                  (parseFloat(AddComponent.creditTextField) / 100) *
                  100,
              ) / 100,
            );
          }
          ...
          for (let i = 0; i < AppStateService.instance.liabilities.length; i++) {
            if (
              '@' + AppStateService.instance.liabilities[i].tag.toLowerCase() ===
              AddComponent.categoryTextField.toLowerCase()
            ) {
              found = true;
              ...
              for (let e = 0; e < AppStateService.instance.allGrowProjects.length; e++) {
                if (
                  AppStateService.instance.allGrowProjects[e].title ===
                  AddComponent.categoryTextField.replace('@', '')
                ) {
                  AppStateService.instance.allGrowProjects[e].liabilitie.amount =
                    AppStateService.instance.liabilities[i].amount;
                  AppStateService.instance.allGrowProjects[e].liabilitie.credit =
          ...
          if (!found) {
            for (let i = 0; i < AppStateService.instance.allAssets.length; i++) {
              if (
                '@' + AppStateService.instance.allAssets[i].tag.toLowerCase() ===
                AddComponent.categoryTextField.toLowerCase()
              ) {
                isInvesmtent = true;
              }
            ...
            for (let i = 0; i < AppStateService.instance.allShares.length; i++) {
              if (
                '@' + AppStateService.instance.allShares[i].tag.toLowerCase() ===
                AddComponent.categoryTextField.toLowerCase()
              ) {
                isInvesmtent = true;
              }
            ...
            for (let i = 0; i < AppStateService.instance.allInvestments.length; i++) {
              if (
                '@' + AppStateService.instance.allInvestments[i].tag.toLowerCase() ===
                AddComponent.categoryTextField.toLowerCase()
              ) {
                isInvesmtent = true;
              }
            ...
            const newLiabilitie: Liability = {
              tag: AddComponent.categoryTextField.replace('@', ''),
              amount: parseFloat(AddComponent.loanTextField),
              investment: isInvesmtent,
              credit: parseFloat(AddComponent.creditTextField),
            };
            AppStateService.instance.liabilities.push(newLiabilitie);
            for (let e = 0; e < AppStateService.instance.allGrowProjects.length; e++) {
              if (
                ...
                AppStateService.instance.allGrowProjects[e].liabilitie.amount = parseFloat(
                  AddComponent.loanTextField,
                );
                AppStateService.instance.allGrowProjects[e].liabilitie.credit = parseFloat(
                  AddComponent.creditTextField,
                );
              }
            }
        ...
        if (AddComponent.commentTextField.includes('Payback Liabilitie')) {
          ...
          if (split[2].includes('%')) {
            for (let i = 0; i < AppStateService.instance.liabilities.length; i++) {
              if (
                ...
                amount =
                  AppStateService.instance.liabilities[i].amount * (parseFloat(split[2]) / 100);
              }
            }
          } else {
          ...
          if (split[3].includes('%')) {
            for (let i = 0; i < AppStateService.instance.liabilities.length; i++) {
              if (
                ...
                credit =
                  AppStateService.instance.liabilities[i].credit * (parseFloat(split[3]) / 100);
              }
            }
          } else {
          ...
          for (let i = 0; i < AppStateService.instance.allGrowProjects.length; i++) {
            if (
              ...
              AppStateService.instance.allGrowProjects[i].liabilitie.amount = parseFloat(
                AppStateService.instance.allGrowProjects[i].liabilitie.amount.toFixed(2),
              );
              AppStateService.instance.allGrowProjects[i].liabilitie.credit = parseFloat(
                AppStateService.instance.allGrowProjects[i].liabilitie.credit.toFixed(2),
              );
              if (
        ...
        if (AddComponent.amountTextField != '0' && AddComponent.amountTextField != '') {
          ...
          if (AddComponent.selectedOption === 'Income') {
            ...
            for (let i = 0; i < AppStateService.instance.allIntrests.length; i++) {
              if (
                this.classReference.categoryTextField.toLocaleLowerCase() ===
              ...
              for (let i = 0; i < AppStateService.instance.allShares.length; i++) {
                if (
                  ...
                  const newInterest: Interest = {
                    tag: AppStateService.instance.allShares[i].tag,
                    amount: parseFloat(AddComponent.amountTextField),
                  };
            ...
            if (!found) {
              ...
              for (let i = 0; i < AppStateService.instance.allInvestments.length; i++) {
                if (
                  ...
                  found = true;
                  const newPropertie: Property = {
                    tag: AppStateService.instance.allInvestments[i].tag,
                    amount: parseFloat(AddComponent.amountTextField),
                  };
            ...
            if (!found) {
              ...
              for (let i = 0; i < AppStateService.instance.allGrowProjects.length; i++) {
                if (
                  this.classReference.categoryTextField.toLocaleLowerCase() ===
                  '@' + AppStateService.instance.allGrowProjects[i].title.toLocaleLowerCase()
                ) {
                  found = true;
            ...
            if (!found) {
              const new_revenue: Revenue = {
                tag: this.classReference.categoryTextField.replace('@', ''),
                amount: parseFloat(AddComponent.amountTextField),
              };
  ...
  private saveToLocalStorage() {
    ...
    this.localStorage.saveData(
      'transactions',
      JSON.stringify(AppStateService.instance.allTransactions),
    );
    ...
    if (AppStateService.instance.tier3BalanceLoaded) {
      ...
      this.localStorage.saveData(
        'investments',
        JSON.stringify(AppStateService.instance.allInvestments),
      );
    }
